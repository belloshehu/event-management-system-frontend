...
import { dishValidationSchema, DishValidationSchemaType } from "@/schemas/dish.schema";
import { useCreateDish } from "@/hooks/service-hooks/dish.hooks";
...
export default function DishForm({
  ...
  const { mutateAsync, isPending } = useCreateDish({ catererId });
  ...
  const onSubmit = async (data: DishValidationSchemaType) => {
